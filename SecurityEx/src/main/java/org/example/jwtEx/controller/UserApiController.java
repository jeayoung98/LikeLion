package org.example.jwtEx.controller;
...
import org.example.jwtEx.domain.Role;
import org.example.jwtEx.domain.User;
import org.example.jwtEx.dto.UserLoginResponseDto;
import org.example.jwtEx.jwt.jwtUtil.JwtTokenizer;
import org.example.jwtEx.security.dto.UserLoginDto;
import org.example.jwtEx.service.RefreshTokenService;
import org.example.jwtEx.service.UserService;
...
public class UserApiController {
    ...
    public ResponseEntity login(@RequestBody @Valid UserLoginDto userLoginDto,
        ...
        accessTokenCookie.setMaxAge(Math.toIntExact(JwtTokenizer.ACCESS_TOKEN_EXPIRE_COUNT / 1000)); //30분 쿠키의 유지시간 단위는 초 ,  JWT 의 시간단위는 밀리세컨드
    ...
    public ResponseEntity refreshToken(HttpServletRequest request,HttpServletResponse response) {
        ...
        // 6. 적잘한 응답결과 (ResponseEntity) 를 생성해서 응답.
